...
| 0040 | Splash exit animation (scale+fade via `setOnExitAnimationListener`, later removed in `fa2015c`) + remove redundant VirtualFeed LoadingSpinner; subsequent 400ms delay before `markContentReady()` to ensure skeleton is painted |
