...
describe("isDateString", () => {
  ...
  it("拒绝非严格 YYYY-MM-DD 形式", () => {
    for (const bad of ["2026-9-3", "2026/09/13", "20260913", "", "2026-09-13T00:00:00Z", " 2026-09-13", "2026-09-13 "]) {
  ...
  it("拒绝形式合法但日历不存在的日期", () => {
    ...
    for (const bad of ["2025-02-29", "2026-02-30", "2026-04-31", "2026-13-01", "2026-00-10", "2026-01-00"]) {
      expect(isDateString(bad)).toBe(false);
    }
  });
});
