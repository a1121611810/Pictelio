...
const en = {
  ...
  "error.hint.unauthorized": "Session expired, please sign in again",
  "error.hint.rateLimit": "Too many requests, please try again later",
  ...
  "settings.appearance.languageDesc": "Switch the interface language, applies immediately",
