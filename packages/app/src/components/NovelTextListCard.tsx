  ...
  return (
    ...
    >
      <div class="flex items-start justify-between gap-3">
        <div class="flex-1 min-w-0">
          ...
          >
            <button
              ...
              aria-label={t("novelTextCard.authorAria", { name: props.novel.user.name })}
            >
              @{props.novel.user.name}
            </button>
            <span class="flex-shrink-0">·</span>
            <span class="flex-shrink-0">
              {t("novelTextCard.statsWords", { count: props.novel.text_length.toLocaleString() })}
            </span>
            <span class="flex-shrink-0">·</span>
          ...
          <div class="mt-1.5 flex items-center gap-2 overflow-hidden">
            ...
            {props.novel.novel_ai_type != null && props.novel.novel_ai_type >= 1 && (
              <fluent-badge
                ...
                class="[font-size:var(--fontSizeBase100)]"
              >
                {props.novel.novel_ai_type === 2 ? "AI" : t("novelTextCard.aiAssisted")}
              </fluent-badge>
            )}
            {props.novel.series?.title && (
              <button
                ...
                aria-label={t("novelTextCard.seriesAria", { title: props.novel.series.title })}
              >
                <fluent-badge
                  appearance="subtle"
        ...
        <button
          class={[
            "flex-shrink-0 w-10 h-10 flex items-center justify-center rounded-full focus:outline-hidden focus-visible:ring-2 focus-visible:ring-[var(--colorBrandStroke1)] active:scale-90 transition-transform duration-[var(--durationFast)] ease-[var(--curveEasyEase)]",
            {
