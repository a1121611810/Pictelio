...
export default defineConfig({
  ...
  shortcuts: {
    ...
    "date-input":
      "bg-[var(--colorNeutralBackground1)] border border-[var(--colorNeutralStroke1)] rounded-[var(--borderRadiusSmall)] px-2 py-1 text-[var(--colorNeutralForeground1)] [font-size:var(--fontSizeBase200)] outline-none appearance-none hover:bg-[var(--colorNeutralBackground1Hover)] focus-visible:border-[var(--colorBrandStroke1)] focus-visible:shadow-[0_0_0_1px_var(--colorBrandStroke1)] [&::-webkit-calendar-picker-indicator]:cursor-pointer [&::-webkit-calendar-picker-indicator]:opacity-60 hover:[&::-webkit-calendar-picker-indicator]:opacity-100",
