...
const zhMisc = {
  ...
  "comments.loadFailedReload": "加载评论失败，请重试",
  "comments.loadMoreFailed": "加载更多失败",
  "comments.loadRepliesFailed": "楼层加载失败",
  "comments.sendFailed": "发送失败，请重试",
  "comments.deleteFailed": "删除失败，请重试",
  ...
  // ─── App.vue（静音轻提示宿主，ADR-0187 D5 / #732 + spec tag-mute 边界 #7；
