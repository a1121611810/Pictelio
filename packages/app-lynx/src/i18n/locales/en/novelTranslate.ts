...
const enNovelTranslate = {
  ...
  "novelTranslate.endpoint.apiKey.show": "Show",
  "novelTranslate.endpoint.apiKey.hide": "Hide",
  "novelTranslate.endpoint.apiKey.clear": "Clear",
  ...
  "novelTranslate.endpoint.targetLang.label": "Target Language",
  "novelTranslate.endpoint.targetLang.hint": "BCP-47 code, e.g. zh-CN / en-US",
  "novelTranslate.endpoint.sourceLang.label": "Source Language",
  "novelTranslate.endpoint.sourceLang.hint": "BCP-47 code, e.g. ja / en (empty = auto-detect)",
  "novelTranslate.endpoint.save": "Save",
  "novelTranslate.endpoint.saved": "Saved",
  "novelTranslate.endpoint.save.failed": "Save failed. Please retry.",
  ...
  "novelTranslate.status.placeholder_untranslated": "〔Untranslated〕",
